        ...
        .on('mouseout', function(d) {
          ...
          if (options.highlightOnHover) {
            ...
            for ( var attr in previousAttributes ) {
              ...
              if (attr === 'fill' && self.options.data[d.id] != undefined) {
                $this.style('fill', self.options.data[d.id].fillColor);  
              } else {
  ...
  Datamap.prototype.updateChoropleth = function(data, options) {
    ...
    if ( options && options.reset === true ) {
      svg.selectAll('.datamaps-subunit')
        ...
        // the colors must be resetted to the default fill since it's being used
        // in the mouseout to paint the correct color
        for ( var subunit in this.options.data ) {
          this.options.data[subunit].fillColor = this.options.fills.defaultFill;
        }
    }
